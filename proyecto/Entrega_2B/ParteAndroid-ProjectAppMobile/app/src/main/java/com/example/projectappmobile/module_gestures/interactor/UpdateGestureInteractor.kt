...
class UpdateGestureInteractor  (
    private val context: Context,
    private val callBackPresenter: UpdateGestureContracts.Presenter,
    private val handler: Handler
): UpdateGestureContracts.Interactor{

    companion object {
        val TAG = "UpdateGestureInteractor"
    }
    ...
    override fun commitGestureInDB(id_function: Int, username_user: String, name: String) {
        ...
        map.put("last_id_function", id_function)
        ...
        val call: Call<MyServerResponseDataString>? = apiInterface?.updateGestureWithSamples(map)
        call?.enqueue(object : Callback<MyServerResponseDataString?> {
            override fun onResponse(
                ...
                Log.d(TAG, "onResponse: commitGestureInDB: " + response.body())
