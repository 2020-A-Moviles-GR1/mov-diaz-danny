...
class AddGesturePresenter (
    private val context: Context,
    private val view: AddGestureContracts.View,
    private val handler: Handler
): AddGestureContracts.Presenter{

    private val interactor: AddGestureContracts.Interactor

    init {
        interactor = AddGestureInteractor(context, this, handler)
    }

    override fun onPopulateSpinnerFunctions() {
        view.showProgressBar()
        interactor.getFunctions()
    }

    override fun onGetFunctionsSuccess(functions: List<Function>) {
